export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxb32639b87f1da66e",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "5e6420138a5eac52675feed5ee28b2e3",
   ...
   */
  USERS: [oFtXH6EGwGGVt2CkSxQ2ksDYS3F0
    {
      // 想要发送的人的名字
      name: "老婆",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2003", "date": "10-22"},
        {"type": "节日", "name": "结婚纪念日", "year": "2025", "date": "10-10"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "小蒋", "year": "1999", "date": "04-11"},
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "老婆", "year": "2003", "date": "10-22", isShowAge: true},
    {"type": "节日", "name": "结婚纪念日", "year": "2025", "date": "10-10"},
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
    {"type": "生日", "name": "小蒋", "year": "1999", "date": "04-11", isShowAge: true},
    {"type": "节日", "name": "被搭讪纪念日", "year": "2022", "date": "07-31"},
    // 你可以不断按格式往下增加
    // ...
  ],
